...
class SelectRole extends \acf_field_select {
	...
	function initialize() {
		...
		// ajax
		add_action('wp_ajax_acf/fields/role_select/query',			array($this, 'ajax_query'));
		add_action('wp_ajax_nopriv_acf/fields/role_select/query',	array($this, 'ajax_query'));
